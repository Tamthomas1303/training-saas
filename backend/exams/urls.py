...
urlpatterns = [
    ...
    path(
        'attempts/<int:pk>/proctoring-event/', ProctoringEventView.as_view(),
        name='exam-attempt-proctoring-event',
    ),
    path('attempts/<int:pk>/proctoring/', AttemptProctoringView.as_view(), name='exam-attempt-proctoring'),
    path('attempts/<int:pk>/flag/', AttemptFlagView.as_view(), name='exam-attempt-flag'),
