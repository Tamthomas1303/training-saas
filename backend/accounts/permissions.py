...
class EmployeeLearnerScope(BasePermission):
    """Tai khoan hoc vien (role='employee', gan qua Employee.user - module Khoa hoc/Ky thi/Noi
    he thong MVP dot 1-3) CHI duoc goi API duoi /api/courses/, /api/exams/, /api/integration/
    (+ /api/auth/me, /api/auth/me/change-password de xem thong tin/doi mat khau cua chinh
    minh) - KHONG duoc doc du lieu quan tri noi bo (nhan su, checklist, KPI, danh gia...) qua
