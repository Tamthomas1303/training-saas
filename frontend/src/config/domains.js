...
import {
  Award, Building2, CalendarCheck, CheckCircle2, ClipboardList, Database, FileText,
  Image, Medal, PencilLine, Rocket, ScrollText, Search, Target, User, Users, Video, GraduationCap,
} from 'lucide-react'
...
export const DOMAINS = [
  {
    ...
    children: [
      { label: 'Danh sách nhân sự mới', path: '/employees', icon: Users, roles: ['admin', 'om', 'bod'] },
      { label: 'Đào tạo tại điểm', path: '/training', icon: GraduationCap, roles: ['admin', 'om', 'bql', 'trainer', 'am', 'kcs'] },
      { label: 'Đánh giá', path: '/evaluation', icon: CheckCircle2, roles: ['admin', 'om', 'bql', 'am', 'kcs'] },
      { label: 'Checklist đào tạo', path: '/checklist', icon: ClipboardList, roles: ['admin', 'om', 'bod'] },
      { label: 'Tiêu chí đánh giá', path: '/criteria', icon: FileText, roles: ['admin', 'om'] },
      { label: 'Khóa học trực tuyến', path: '/courses-admin', icon: Video, roles: ['admin'] },
      { label: 'Ngân hàng câu hỏi', path: '/exam-banks', icon: Database, roles: ['admin'], group: 'Nội dung' },
  ...
  },
  {
    ...
    children: [
      { label: 'Lộ trình thăng tiến', path: '/levelup', icon: Rocket, roles: ['admin', 'om', 'bql', 'am', 'kcs', 'trainer'] },
    ],
  },
  {
    key: 'source',
    ...
    children: [
      { label: 'Danh sách nhân sự nguồn', path: '/levelup', icon: Medal, roles: ['admin', 'om'] },
      { label: 'Ban quản lý — Đào tạo & Đánh giá', path: '/mgmt-development', icon: ClipboardList, roles: ['admin', 'om', 'bod'] },
      { label: 'Chương trình, Đợt & Nội dung', path: '/sourcing?audience=management', icon: GraduationCap, roles: ['admin', 'om', 'bql', 'trainer'] },
      { label: 'Lập danh sách theo khung năng lực', path: '/competency-gap', icon: Search, roles: ['admin', 'om', 'am', 'kcs', 'bql', 'trainer'] },
    ],
  },
  {
    key: 'mid',
    ...
    children: [
      { label: 'Chương trình & Đợt (cấp trung)', path: '/sourcing?audience=middle', icon: Building2, roles: ['admin', 'om'] },
    ],
  },
]
